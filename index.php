<?php
ob_start();
define('API_KEY','254304385:AAHqxBwebDSvgpQje4TnN5WoK5UIy-7RuSQ');
$admin = "222978403";
...
".$jsu;
  ...
  bot('sendmessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'MR_Areza','url'=>'https://telegram.me/MR_Areza']
        ],
        [
          ['text'=>'Pm resan bot','url'=>'https://telegram.me/Areza_pvbot']
        ]
      ]
    ])
  ]);
